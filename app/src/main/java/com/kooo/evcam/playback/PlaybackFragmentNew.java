...
public class PlaybackFragmentNew extends Fragment {
    ...
    private void updateSelectedCount() {
        selectedCount.setText("Selected " + adapter.getSelectedCount() + " item(s)");
    }
    ...
    private void deleteSelected() {
        ...
        new MaterialAlertDialogBuilder(getContext(), R.style.Theme_Cam_MaterialAlertDialog)
                ...
                .setMessage("Delete selected " + selectedGroups.size() + " video group(s)? (includes all camera recordings)")
                .setPositiveButton("Delete", (dialog, which) -> {
                    ...
                    if (getContext() != null) {
                        android.widget.Toast.makeText(getContext(),
                                "Deleted " + deletedCount + " video file(s)",
