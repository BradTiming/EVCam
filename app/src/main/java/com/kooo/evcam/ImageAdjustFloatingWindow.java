...
public class ImageAdjustFloatingWindow {
    ...
    private View createFloatingView() {
        ...
        if (contentLayout.getChildCount() == 0) {
            ...
            noParamsText.setText("Current device does not support brightness/noise reduction");
    ...
    private LinearLayout createTitleBar() {
        ...
        titleText.setText("Brightness/Noise Tuning");
    ...
    private LinearLayout createEdgeSection() {
        LinearLayout section = createSection("Sharpening");
        ...
        edgeSelectText = createSelectTextView(
                ...
                v -> showSelectionDialog("Sharpening", edgeOptions, edgeModeValues, adjustManager.getEdgeMode(),
                        value -> {
