...
public class PermissionSettingsFragment extends Fragment {
    ...
    private void updateMicrophonePermissionStatus() {
        ...
        if (granted) {
            ...
            tvMicrophoneStatus.setText("Not granted - recordings will have no audio");
    ...
    private void updateNotificationPermissionStatus() {
        ...
        if (granted) {
            ...
            tvNotificationStatus.setText("Not granted - cannot show recording status notifications");
    ...
    private void updateAllFilesPermissionStatus() {
        ...
        if (granted) {
            ...
            tvAllFilesStatus.setText("Not granted - cannot store files on USB drive");
    ...
    private void updateOverlayPermissionStatus() {
        ...
        if (granted) {
            ...
            tvOverlayStatus.setText("Not granted - floating window and background wake are unavailable");
    ...
    private void updateBatteryOptimizationStatus() {
        ...
        if (ignored) {
            ...
            tvBatteryStatus.setText("Optimizing - app may be put to sleep");
    ...
    private void updateUsageStatsPermissionStatus() {
        ...
        if (granted) {
            ...
            tvUsageStatsStatus.setText("Not granted - panorama avoidance feature unavailable");
    ...
    private void startAdbGrant() {
        ...
        adbHelper.grantAllPermissions(new AdbPermissionHelper.Callback() {
            ...
            public void onComplete(boolean allSuccess) {
                ...
                btnAdbGrantAll.setText("Grant All via ADB");
                // 刷新所有权限状态显示
                updateAllPermissionStatus();
            }
        });
    ...
    private void showWhitelistRiskDialog() {
        ...
        new MaterialAlertDialogBuilder(getContext(), R.style.Theme_Cam_MaterialAlertDialog)
                ...
                .setMessage("This action modifies system partition whitelist files. Please read carefully:\n\n"
                        + "1. Only for Galaxy E5 (E245) head units\n"
                        + "2. USB debugging must be enabled\n"
                        + "3. It will modify 3 XML files under system/vendor partitions\n"
                        + "4. Original files are backed up to /sdcard/evcam_backup/ before changes\n"
                        + "5. A head-unit reboot is required after completion\n"
                        + "6. Use at your own risk; you are responsible for any issues\n"
                        + "7. Script will auto-detect and stop if device is not E245\n\n"
    ...
    private void startWhitelistSetup() {
        ...
        whitelistHelper.executeWhitelistSetup(new SystemWhitelistHelper.Callback() {
            ...
            public void onComplete(boolean success) {
                ...
                btnSystemWhitelist.setText("One-tap Configure");

                if (getContext() == null) return;

                if (success) {
                    tvWhitelistStatus.setText("Configuration successful - please reboot the head unit to apply");
    ...
    private void showRestoreConfirmDialog() {
        ...
        new MaterialAlertDialogBuilder(getContext(), R.style.Theme_Cam_MaterialAlertDialog)
                ...
                .setMessage("This action restores system whitelist settings from backup:\n\n"
                        + "1. EVCam whitelist entries will be removed\n"
                        + "2. System config files will be restored to their original state\n"
                        + "3. A head-unit reboot is required\n"
                        + "4. If one-tap configuration caused feature issues before, restore should fix them\n\n"
                        + "Do you want to restore?")
                .setPositiveButton("Restore", (dialog, which) -> startWhitelistRestore())
                .setNegativeButton("Cancel", null)
                .show();
    }
    ...
    private void startWhitelistRestore() {
        ...
        whitelistHelper.executeWhitelistRestore(new SystemWhitelistHelper.Callback() {
            ...
            public void onComplete(boolean success) {
                ...
                if (success) {
                    tvWhitelistStatus.setText("Restored - please reboot the head unit to apply");
                    tvWhitelistStatus.setTextColor(getResources().getColor(android.R.color.holo_green_dark, null));
                } else {
