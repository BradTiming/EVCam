...
This software is an experimental open-source project and has not passed any automotive functional-safety certification. Do NOT use it for real driving decisions.

Technical risks include, but are not limited to:
- Video stream latency over 200ms (affected by system load and encoding performance)
- Stutter, tearing, color distortion, or complete interruption
- Resource contention with the head-unit system, possibly affecting OEM safety features (e.g., reverse camera, ADAS)
